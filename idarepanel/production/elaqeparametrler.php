            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <?php }else{ ?>
                    Porto websayıtındakı əlaqə parametirləri buradan yeniliyə bilərsiniz...
                  <?php } ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="ayar_faks" value="<?php echo $ayarCek['ayar_faks'];?>" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">E-mail Adresi
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="ayar_mail" value="<?php echo $ayarCek['ayar_mail'];?>" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Ölkə
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="ayar_olka" value="<?php echo $ayarCek['ayar_olka'];?>" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="ayar_seher" value="<?php echo $ayarCek['ayar_seher'];?>" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">İş Vaxtı
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="ayar_isvaxti" value="<?php echo $ayarCek['ayar_isvaxti'];?>" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button name="elayaryenile" type="submit" class="btn btn-success">Yenilə</button>
                        </div>
                      </form>                      
                  </div> 
                </div>
